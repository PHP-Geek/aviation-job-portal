<div class="content-wrapper">
    <section class="content-header">
        <h1 style="display:inline-block">Entry Into Service</h1>
		<a href=<?php echo base_url(); ?>page/add_entry_into_service/">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Entry Into Service</li>
        </ol>
    </section>
...
<script type="text/javascript">
	$(function () {
		$('#location_datatable').dataTable({
			"aaSorting": [['0', 'asc']],
			"sAjaxSource": base_url + "page/entry_into_service_datatable",
			"oLanguage": {
			...
			"aoColumnDefs": [
				...
				},
				{
					...
					"mRender": function (data, type, full) {
						switch (data) {
							case '1':
								return '<div class="text-center"><input onchange="entry_into_service_status(' + full[0] + ')" id="id_' + full[0] + '" type="checkbox" checked="checked" /></div>';
								break;
							default:
								return '<div class="text-center"><input onchange="entry_into_service_status(' + full[0] + ')" id="id_' + full[0] + '" type="checkbox" /></div>';
								break;
						}
					}
				}, {
					...
					"mData": null,
					"mRender": function (data, type, full) {
						return '<div class="text-center"><a href="' + base_url + 'page/edit_entry_into_service/' + full[0] + '" class="btn btn-sm btn-info"><i class="fa fa-pencil-square-o"></i> Edit</a></div>'
					}
				}
	...
	function entry_into_service_status(entry_into_service_id) {
		$.post(base_url + 'page/change_entry_into_service_status', {entry_into_service_id: entry_into_service_id, entry_into_service_status: $("#id_" + entry_into_service_id).is(':checked')}, function (data) {
			if (data === '1') {
