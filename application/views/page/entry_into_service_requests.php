<div class="content-wrapper">
    <section class="content-header">
        <h1>Entry into Service Requests <small>listing of all entry into service requests</small></h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>dashboard"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active">Entry into Service Requests</li>
        </ol>
    </section>
...
<script type="text/javascript">
	...
	$(function () {
		$('#contact_datatable').dataTable({
			"aaSorting": [['0', 'asc']],
			"sAjaxSource": base_url + "page/entry_into_service_requests_datatable",
			"oTableTools": {
