<div class="content-wrapper">
    <section class="content-header">
        <h1 style="display:inline-block">About Increw Posts</h1>
		<a href="<?php echo base_url(); ?>page/add_about_us">
...
<script type="text/javascript">
	$(function () {
		$('#location_datatable').dataTable({
			"aaSorting": [['0', 'asc']],
			"sAjaxSource": base_url + "page/about_us_datatable",
			"oLanguage": {
			...
			"aoColumnDefs": [
				...
				},
				{
					...
					"mRender": function (data, type, full) {
						switch (data) {
							case '1':
								return '<div class="text-center"><input onchange="about_us_status(' + full[0] + ')" id="id_' + full[0] + '" type="checkbox" checked="checked" /></div>';
								break;
							default:
								return '<div class="text-center"><input onchange="about_us_status(' + full[0] + ')" id="id_' + full[0] + '" type="checkbox" /></div>';
								break;
						}
					}
				}, {
					...
					"mData": null,
					"mRender": function (data, type, full) {
						return '<div class="text-center"><a href="' + base_url + 'page/edit_about_us/' + full[0] + '" class="btn btn-sm btn-info"><i class="fa fa-pencil-square-o"></i> Edit</a></div>'
					}
				}
	...
	function about_us_status(about_increw_id) {
		$.post(base_url + 'page/change_about_us_status', {about_increw_id: about_increw_id, about_increw_status: $("#id_" + about_increw_id).is(':checked')}, function (data) {
			if (data === '1') {
