...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Add Home Page Testimonial <small>add home page testimonial</small></h1>
        <ol class="breadcrumb">
			<li><a href="<?php echo base_url(); ?>dashboard"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active">Add Home Page Testimonial</li>
        </ol>
    </section>
            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Add Home Page Testimonial</h3>
                    </div>
                    <form id="add_home_page_testimonial_form" method="post" enctype="multipart/form-data" role="form">
                        <div class="box-body">
						...
						<div class="box-footer text-center">
							<button id="add_home_page_testimonial_button" type="button" class="btn btn-primary" onclick="add_home_page_testimonial();" data-loading-text="Please Wait..">Update </button>
						</div>
					</form>
				</div>
			</div>
...
<script type="text/javascript">
								function add_home_page_testimonial() {
									$("add_home_page_testimonial_button").button('loading');
									$.post('', $("#add_home_page_testimonial_form").serialize(), function (data) {
										if (data === '1') {
											bootbox.alert('Testimonial Added Successfully.', function () {
												document.location.href = base_url + 'page/home_page_testimonial';
											});
										} else if (data === '0') {
