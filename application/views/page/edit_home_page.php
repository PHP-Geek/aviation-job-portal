...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Edit Home Page Writings <small>Edit Home Page Writings</small></h1>
        <ol class="breadcrumb">
			<li><a href="<?php echo base_url(); ?>dashboard"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li class="active">Edit Home Page Writings</li>
        </ol>
    </section>
            ...
            <div class="col-md-12 col-md-offset-0">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Edit Home Page Writings</h3>
                    </div>
                    <form id="edit_page_content_form" method="post" enctype="multipart/form-data" role="form">
						...
						<div class="box-footer">
							<a href="<?php echo base_url(); ?>page/list_home_page" class="btn btn-default pull-left"><i class="fa fa-chevron-left"></i> Cancel</a>
							<button id="edit_page_content_button" type="button" class="btn btn-primary pull-right" onclick="edit_page_content();" data-loading-text="Please Wait..">Update <i class="fa fa-chevron-right"></i></button>
						</div>
					</form>
				</div>
			</div>
									...
									$.post('', $("#edit_page_content_form").serialize(), function (data) {
										if (data === '1') {
											bootbox.alert('Updated Successfully.', function () {
												document.location.href = base_url + 'page/list_home_page';
											});
										} else if (data === '0') {
