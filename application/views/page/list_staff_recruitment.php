<div class="content-wrapper">
    <section class="content-header">
        <h1 style="display:inline-block">Staff Recruitment Posts</h1>
		<a href="<?php echo base_url(); ?>page/add_staff_recruitment">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Staff Recruitment Posts</li>
        </ol>
    </section>
...
<script type="text/javascript">
	$(function () {
		$('#crew_datatable').dataTable({
			"aaSorting": [['0', 'asc']],
			"sAjaxSource": base_url + "page/list_staff_recruitment_datatable",
			"oLanguage": {
			...
			"aoColumnDefs": [
				...
				},
				{
					...
					"mRender": function (data, type, full) {
						switch (data) {
							case '1':
								return '<div class="text-center"><input onchange="change_staff_recruitment_status(' + full[0] + ')" id="id_' + full[0] + '" type="checkbox" checked="checked" /></div>';
								break;
							default:
								return '<div class="text-center"><input onchange="change_staff_recruitment_status(' + full[0] + ')" id="id_' + full[0] + '" type="checkbox" /></div>';
								break;
						}
					}
				}, {
					...
					"mData": null,
					"mRender": function (data, type, full) {
						return '<div class="text-center"><a href="' + base_url + 'page/edit_staff_recruitment/' + full[0] + '" class="btn btn-sm btn-info"><i class="fa fa-pencil-square-o"></i> Edit</a></div>'
					}
				}
	...
	function change_staff_recruitment_status(staff_recruitment_id) {
		$.post(base_url + 'page/change_staff_recruitment_status', {staff_recruitment_id: staff_recruitment_id, staff_recruitment_status: $("#id_" + staff_recruitment_id).is(':checked')}, function (data) {
			if (data === '1') {
