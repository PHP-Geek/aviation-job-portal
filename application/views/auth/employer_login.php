        ...
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Employer Register</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="container">
    <div class="row">
        <div class="col-md-4 col-sm-6 col-lg-4">
            <h2>Register</h2>
            <p>Please select which sector are you in. </p>
			<?php foreach ($employer_types_array as $employer_type) { ?>
				<a href="<?php echo base_url(); ?>register/employer/<?php echo $employer_type['employer_type_slug']; ?>"><div class="register-category">
						<p><span class="fa fa-plane"></span>&nbsp;<?php echo $employer_type['employer_type']; ?></p>
					</div></a>
			<?php } ?>
        </div>
									...
									$("#user_login_form").validate({
										...
										messages: {
											...
											user_captcha: {
												...
												remote: "Please enter correct captcha image"
											}
										},
