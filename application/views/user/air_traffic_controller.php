...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Users : Air Traffic Controllers <small>listing of all air traffic controllers</small></h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>dashboard"><i class="fa fa-dashboard"></i> Dashboard</a></li>
			<li>Users</li>
            <li class="active">Air Traffic Controllers</li>
        </ol>
    </section>
						...
						<tbody>
							<?php foreach ($users_array as $user) { ?>
								<tr>
									...
									<td><?php echo $user['job_type_name']; ?></td>
...
<script>
						$(document).ready(function () {
							...
							var table = $('#example').DataTable({
								"order": [[0, "asc"]],
								"stateSave": true,
								"lengthMenu": [[10, 20, 50, 100, 200, 500, -1], [10, 20, 50, 100, 200, 500, "All"]], "pagingType": "full_numbers",
