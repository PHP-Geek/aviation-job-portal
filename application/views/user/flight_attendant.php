...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Users : Flight Attendant <small>listing of all flight attendants</small></h1>
        <ol class="breadcrumb">
						...
						<tbody>
							<?php foreach ($users_array as $user) { ?>
								<tr>
									...
									<td><?php echo $user['employee_role_name']; ?></td>
									<td><?php echo $user['user_years_of_experience']; ?></td>
