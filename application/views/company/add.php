<div class="content-wrapper">
    <section class="content-header">
        <h1>Add Company <small>Add Company</small></h1>
        <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="box box-primary">
                    ...
                    <form id="add_company_form" method="post" enctype="multipart/form-data" role="form">
                        <div class="box-body">
							...
							<div class="form-group">
								...
								<textarea rows="6" name="company_description" id="company_description" class="form-control" placeholder="Add Company Description"></textarea>
							</div>
							<div class="form-group" id="image-container">
								<a title="" id="image_uploader" href="javascript:;" class="btn btn-md btn-success"><i class="fa fa-photo"></i> Select Image</a>
								<label for="company_image"> Company Logo <abbr>(*.jpg, .png)</abbr></label>
							</div>
							<ul id="uploaded_images" style="list-style-type: none;"></ul>
						</div>
						<div class="box-footer text-center">
							<button id="add_company_button" type="button" class="btn btn-primary pull-right">Add Company <i class="fa fa-angle-right"></i></button>
						</div>
					</form>
				</div>
			</div>
...
<script type="text/javascript">
	$("#add_company_button").click(function () {
		$("#add_company_button").button('loading');
		$.post('', $("#add_company_form").serialize(), function (data) {
			if (data === '1') {
				bootbox.alert("Company Added Successfully", function () {
			...
			$("#add_company_button").button('reset');
		});
	});
	$(function () {
		var image_uploader = new plupload.Uploader({
			...
			init: {
				FilesAdded: function (up, files) {
					...
					setTimeout(function () {
						up.start();
						$('#add_company_form').block({message: 'Please wait...'});
					}, 1);
				},
				FileUploaded: function (up, file) {
					$("#uploaded_images").append('<li class="col-md-6"><a title="" class="pull-right remove_image_button" onclick="$(this).parent().remove();" style="cursor:pointer"><i class="fa fa-2x fa-times-circle"></i></a><div class="panel panel-default"><div class="panel-body"><input type="hidden" name="company_logo" value="' + file.target_name + '"><img alt="" class="img img-responsive" src="' + base_url + 'uploads/' + file.target_name + '" /></div></div></li>');
				},
				UploadComplete: function () {
					$('#add_company_form').unblock();
				},
