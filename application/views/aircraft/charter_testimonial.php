<div class="content-wrapper">
    <section class="content-header">
        <h1 style="display:inline-block">Charter Testimonials</h1>
		<a href="<?php echo base_url(); ?>aircraft/add_charter_testimonial" class="btn btn-primary btn-md">
...
<script type="text/javascript">
	$(function () {
		$('#location_datatable').dataTable({
			"aaSorting": [['0', 'asc']],
			"sAjaxSource": base_url + "aircraft/charter_testimonial_datatable",
			"oLanguage": {
			...
			"aoColumnDefs": [
				...
				},
				{
					...
					"mData": null,
					"mRender": function (data, type, full) {
						return '<div class="text-center"><a href="' + base_url + 'aircraft/edit_charter_testimonial/' + full[0] + '" class="btn btn-sm btn-info"><i class="fa fa-pencil-square-o"></i> Edit</a></div>'
					}
				}
	...
	function home_page_testimonial_status(home_page_testimonial_id) {
		$.post(base_url + 'aircraft/change_aircraft_charter_testimonial_status', {home_page_testimonial_id: home_page_testimonial_id, home_page_testimonial_status: $("#id_" + home_page_testimonial_id).is(':checked')}, function (data) {
			if (data === '1') {
