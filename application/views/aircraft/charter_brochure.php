            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="box box-primary">
					...
					<div class="well text-center">
						<h4><span class="text-info">Total Number of Downloads</span> : <?php echo $charter_brochure_array['configuration_value']; ?></h4>
					</div>
                    <form id="update_charter_brochure_form" method="post" enctype="multipart/form-data" role="form">
                        <div class="box-body">
							<div class="form-group text-center" id="file-containter">
								<?php
								if (is_file(FCPATH . 'uploads/brochures/charter/' . $configuration_array['configuration_value'])) {
									?>
									<a href="<?php echo base_url() . 'uploads/brochures/charter/' . $configuration_array['configuration_value']; ?>" title="click to view" id="pdf_link" target="_blank"><i class="fa fa-file-pdf-o fa-5x"></i></a>
									<br><a href="<?php echo base_url() . 'uploads/brochures/charter/' . $configuration_array['configuration_value']; ?>" title="click to view" id="pdf_link" target="_blank">Click to view brochure</a><?php } ?><br><hr>
								<a title="Select Image" id="file_uploader" href="javascript:;" class="btn btn-success"><i class="fa fa-file-pdf-o"></i> Select File</a>
								<label for="file_name"> Change Charter Brochure <abbr>(.pdf , 100 MB max)</abbr></label>
